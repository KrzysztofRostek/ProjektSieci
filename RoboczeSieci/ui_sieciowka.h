...
public:
    ...
    void setupUi(QDialog *Sieciowka)
    {
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::LabelRole, label_port);
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::FieldRole, polePort);

        label_ip = new QLabel(grupaSieciowa);
        label_ip->setObjectName("label_ip");

        formLayout->setWidget(1, QFormLayout::ItemRole::LabelRole, label_ip);

        poleIP = new QLineEdit(grupaSieciowa);
        poleIP->setObjectName("poleIP");

        formLayout->setWidget(1, QFormLayout::ItemRole::FieldRole, poleIP);
